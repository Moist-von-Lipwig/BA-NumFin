...
# Paths = [100, 1000, 10000, 100000, 1000000]  # long run ~ 5min
Paths = [100, 1000, 10000, 100000]  # short run ~20 seconds
...
for N in Paths:
    ...
    for j in range(Number_Estimations):
        ...
        MC_Solutions[j], _ = OpPrAp.EUR_Opt_Approx(Price_Process, Strike, Interest,
                                                   Exercise_Time, 'Call')
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_1Hlt_Solutions[j], _ = OpPrAp.EUR_Opt_Approx(Price_Process, Strike, Interest,
                                                          Exercise_Time, 'Call')
        ...
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_2Hlt_Solutions[j], _ = OpPrAp.EUR_Opt_Approx(Price_Process, Strike, Interest,
                                                          Exercise_Time, 'Call')
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_Fre_Solutions[j], _ = OpPrAp.EUR_Opt_Approx(Price_Process, Strike, Interest,
                                                         Exercise_Time, 'Call')
