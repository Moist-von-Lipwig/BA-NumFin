...
for N in Paths:
    ...
    for j in range(Number_Estimations):
        ...
        MC_Solutions[j], _ = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_1Hlt_Solutions[j], _ = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
                                                            'Call', 'Discrete', 'Geometric')
        ...
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_2Hlt_Solutions[j], _ = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
                                                            'Call', 'Discrete', 'Geometric')
