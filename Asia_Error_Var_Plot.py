...
for N in Paths:
    ...
    MC_Solutions[i], MC_Variances[i] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    QMC_Hlt_Solutions[i], QMC_Hlt_Variances[i] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
                                                                         'Call', 'Discrete', 'Geometric')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    QMC_Fre_Solutions[i], QMC_Fre_Variances[i] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest, Exercise_Time,
                                                                         'Call', 'Discrete', 'Geometric')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    rQMC_1Hlt_Solutions[i], rQMC_1Hlt_Variances[i] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest,
                                                                             Exercise_Time,
                                                                             'Call', 'Discrete', 'Geometric')
    ...
    for shift in range(Number_Shifts):
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        shifted_Values[shift], shifted_Variance[shift] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest,
                                                                                 Exercise_Time, 'Call',
                                                                                 'Discrete', 'Geometric')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    rQMC_Fre_Solutions[i], rQMC_Fre_Variances[i] = OpPrAp.Asian_Opt_Approx(Price_Process, Strike, Interest,
                                                                           Exercise_Time, 'Call',
                                                                           'Discrete', 'Geometric')
...
plt.title("Varianzrate für die diskrete geometrische Asiatische Call Option")
plt.xlabel("Anzahl Simulationen")
