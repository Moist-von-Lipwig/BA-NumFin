...
for N in Paths:
    ...
    MC_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    QMC_Hlt_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
                                                         Exercise_Time, 'Call', 'Fixed')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    QMC_Fre_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
                                                         Exercise_Time, 'Call', 'Fixed')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    rQMC_1Hlt_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
                                                           Exercise_Time, 'Call', 'Fixed')
    ...
    # Calculate payoff for each brownian motion and estimate mean and variance
    rQMC_2Hlt_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
                                                           Exercise_Time, 'Call', 'Fixed')
    ...
    Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
    # Calculate payoff for each brownian motion and estimate mean and variance
    rQMC_Fre_Solutions[i], _ = OpPrAp.Lookback_Opt_Approx(Price_Process, Strike, Interest,
                                                          Exercise_Time, 'Call', 'Fixed')
