...
for N in Paths:
    ...
    for j in range(Number_Estimations):
        ...
        MC_Solutions[j], _ = OpPrAp.Barrier_Opt_Approx(Price_Process, Strike, Barrier, Interest, Exercise_Time,
                                                       'Call', 'Down', 'In')
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_1Hlt_Solutions[j], _ = OpPrAp.Barrier_Opt_Approx(Price_Process, Strike, Barrier, Interest, Exercise_Time,
                                                              'Call', 'Down', 'In')
        ...
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_2Hlt_Solutions[j], _ = OpPrAp.Barrier_Opt_Approx(Price_Process, Strike, Barrier, Interest, Exercise_Time,
                                                              'Call', 'Down', 'In')
        ...
        Price_Process = OpPrAp.PriceProcesses(Start_Price, Interest, Volatility, Timepoints_for_PP, Brownian_Motion)
        # Calculate payoff for each brownian motion and estimate mean and variance
        rQMC_Fre_Solutions[j], _ = OpPrAp.Barrier_Opt_Approx(Price_Process, Strike, Barrier, Interest, Exercise_Time,
                                                             'Call', 'Down', 'In')
...
plt.title("Geschätzte Varianz des Schätzers für die Down-In Barrier Call Option")
